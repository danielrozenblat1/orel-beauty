...
import logo from "../../images/אוראל ביוטי אייקון.png"
...
const NavBarNew = () => {
  ...
  const reciver = "orelhen123@gmail.com"; // המייל של אוראל
      ...
      `}>
        <div className={styles.navbarInner}>
          <div className={styles.logo}>
            {/* <img src={logo} alt="אוראל מני פדי לוגו" /> */}
          </div>
          ...
          <div className={`${styles.mobileMenu} ${isClosing ? styles.closing : ''}`}>
            <div className={styles.mobileMenuHeader}>
              ...
              {/* <div className={styles.mobileMenuLogo}>
                <img src={logo} alt="אוראל לוי לוגו"/>
              </div> */}
            </div>
